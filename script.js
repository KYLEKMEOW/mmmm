document.addEventListener("DOMContentLoaded", function () {
    ...
    const players = [
		...
		{ name: '️🦉ⓂShaSha', score: 159411 },
		{ name: '️Kisylya', score: 124775884 },
		{ name: '️MYrMeOW', score: 145995881 },
...
function formatNumber(number) {
    if (number >= 500000000) return '999999999999999'; // Добавлено условие для предела в 20 миллионов
